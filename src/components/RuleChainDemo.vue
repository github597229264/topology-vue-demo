<template>
  <el-container>
    ...
    <el-main>
      ...
      <tab :data="nodeData" :table="table"></tab>
    </el-main>
  </el-container>
  ...
  export default {
    ...
    data() {
      return {
        ...
        table: false//控制弹框出现  true弹框出现  false弹框隐藏
      }
    },
    created() {
      //2. 注册图形库
    ...
    methods: {
      ...
      showCanvasByData(data){
        ...
        let aLines = [];
        let aRuleChain = [
          {"id":{"entityType":"RULE_CHAIN","id":"f96f9c99"},"createdTime":1584331354388,"additionalInfo":null,"tenantId":{"entityType":"ruleChainControl","id":"f752bc20-673a-11ea-a56e-fd5e0ea8fd27"},"name":"Root Rule Chain","firstRuleNodeId":{"entityType":"RULE_NODE","id":"f75eca10-673a-11ea-a56e-fd5e0ea8fd27"},"root":true,"debugMode":false,"configuration":null},
          {"id":{"entityType":"RULE_CHAIN","id":"e09a68b6"},"createdTime":1584518144734,"additionalInfo":null,"tenantId":{"entityType":"ruleChainControl","id":"f752bc20-673a-11ea-a56e-fd5e0ea8fd27"},"name":"test22","firstRuleNodeId":{"entityType":"RULE_NODE","id":"20733df0-68ee-11ea-a56e-fd5e0ea8fd27"},"root":false,"debugMode":false,"configuration":null}
        ];//规则链数据
